# Simulador SPR - Nueva Arquitectura (FastAPI + React)

Esta es la nueva versión del simulador de plasmones, diseñada para ser más rápida, escalable e interactiva.
